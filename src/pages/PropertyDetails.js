  ...
  return (
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-grow lg:flex-row">
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              <input
                type="text"
                className="border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-gray-400"
                placeholder="Name*"
              ></input>
              <input
                type="text"
              ...
              ></input>
              <textarea
                className="border border-gray-300 focus:border-violet-700 w-full outline-none rounded p-4 h-36 text-gray-400"
                placeholder="Message*"
              ></textarea>
